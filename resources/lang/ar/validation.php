<?php return array(
    ...
    array(
        ...
        'file_type' => 'نوع الملف',
        'file_url' => 'رابط الملف',
        'file_changes' => 'تغييرات الملف',
        'file_preview' => 'معاينة الملف',
        'category_id' => 'معرف الفئة',
        'print_title' => 'عنوان الطباعة',
        'filament_id' => 'معرف الخيوط',
        'infill_id' => 'معرف الحشو',
        'raft' => 'الطوف',
        'supports' => 'الدعامات',
        'resolution' => 'الدقة',
        'hour' => 'ساعة',
        ...
        'role_id' => 'معرف الدور',
        'moderator_id' => 'معرف المشرف',
        'permissions' => 'الصلاحيات',
        'permissions.*' => 'الصلاحيات.*',
        'offer_percentage' => 'نسبة العرض',
        'product_percentage' => 'نسبة المنتج',
        'withdarw_request_id' => 'معرف طلب السحب',
        'amount' => 'المبلغ',
        'files_id' => 'معرف الملفات',
        'status' => 'الحالة',
        ...
        'files.*src' => 'الملفات.*src',
        'files.*title' => 'الملفات.*العنوان',
        'message' => 'الرسالة',
